...
<nav class="navbar navbar-expand-md navbar-light bg-white sticky-top" style="padding-top: 0; padding-bottom: 0;">
    <div class="container">
        <a style="color: #121668;" class="navbar-brand" href="index.php"><img src="img/logo.png" width="40" /> <b>TopUps.ng</b></a>
                ...
                <?php
                    if($user_session->is_logged_in()){
                        ...
                        ?>
                            ...
                            <li class="nav-item"><a style="color: #fff; font-weight: 100;" class="nav-link btn btn-danger btn-xs" href="signup.php">Register</a></li>
                        <?php
                    }
                ?>
            </ul>
